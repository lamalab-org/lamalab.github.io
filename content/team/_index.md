...
for students pursuing a masters degree, we compiled a list of potential topics.

# Project Ideas

| Project | Lead/Supervisor | Description |
|---------|-----------------|-------------|
| Mechanism parsing & LIFT training | Martiño Ríos-García | Parse mechanism explanations from books/webpages for common reactions, then train using LIFT to potentially improve performance of models like Flower |
